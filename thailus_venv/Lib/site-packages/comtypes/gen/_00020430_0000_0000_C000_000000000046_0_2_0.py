...
__all__ = [ 'OLE_YPOS_HIMETRIC', 'FontEvents', 'Monochrome',
           'FONTUNDERSCORE', 'OLE_OPTEXCLUSIVE', 'FONTSIZE', 'Color',
           'OLE_XPOS_CONTAINER', 'OLE_YPOS_CONTAINER',
           'OLE_XSIZE_HIMETRIC', 'FONTSTRIKETHROUGH',
           'IFontEventsDisp', 'IFontDisp', 'FONTBOLD',
           'OLE_YSIZE_CONTAINER', 'StdFont', 'Font',
           'LoadPictureConstants', 'StdPicture', 'Default', 'Checked',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_CANCELBOOL',
           'OLE_XSIZE_CONTAINER', 'IPictureDisp', 'OLE_XPOS_HIMETRIC',
           'Gray', 'VgaColor', 'OLE_YSIZE_PIXELS',
           'OLE_YSIZE_HIMETRIC', 'IFont', 'OLE_XPOS_PIXELS',
           'FONTITALIC', 'OLE_XSIZE_PIXELS', 'FONTNAME', 'IPicture',
           'OLE_TRISTATE', 'OLE_COLOR', 'OLE_HANDLE', 'Picture',
           'OLE_YPOS_PIXELS', 'Unchecked']
from comtypes import _check_version; _check_version('1.1.10', 1622894692.653069)
